...
const FAM_WORDS = [
  ...
  "Clam shell closing tight", "Oyster shell pearl search", "Blue mussel rock cluster", "Sharp barnacle dock sticking", "Garden snail leaving trail", "Slimy slug slow pathway", "Fuzzy caterpillar walking",
  "Silk cocoon leaf wrapping", "Monarch wings opening wide", "Green dragonfly hover fly", "Damselfly electric blue wings", "Mayfly summer cloud swarm", "Cicada dry shell bark", "Green grasshopper high jump",
  "Black cricket singing warm", "Shiny beetle green back", "Red ladybug black dots", "Fuzzy yellow bumblebee", "Honeybee pollen leg pockets", "Paper wasp nest in attic", "Hornet buzzing threat",
  "Yellowjacket picnic table pest", "Mosquito high pitched buzz", "Horsefly chase panic sprint", "Gnat cloud face tickle", "Tiny flea jumping high", "Dog tick check routine", "Cranberry sauce bog",
  "Wild blueberry picking bucket", "Raspberry bush thorn prick", "Strawberry patch harvest", "Apple orchard ladder climb", "Pumpkin patch tractor ride", "Corn maze getting lost", "Hayride blanket warmth",
  "Autumn leaf color change", "Raking leaves giant pile", "Jumping in dry leaves crackle", "Acorn cup whistle trick", "Pinecone bird feeder peanut butter", "Carving a spooky pumpkin", "Candle light inside jack-o-lantern",
  "Apples bobbing in water tub", "Warm apple cider mug", "Cinnamon stick drink stirrer", "Freshly baked pumpkin pie", "Roasted turkey dinner aroma", "Cranberry sauce wiggle shape", "Mashed potatoes butter pool",
  "Gravy boat pouring warm", "Stuffing herb seasoning smell", "Green bean casserole crunchy onions", "Sweet potato marshmallow topping", "Dinner roll steam escape", "Pecan pie sticky slice", "Washing dinner dishes together",
  "Leftover turkey sandwich feast", "Matching holiday sweater wear", "Decorating the green tree", "Untangling string of lights", "Shiny red ornament reflection", "Star on top of tree", "Sledding down snowy hill",
...
const ONLINE_WORDS = [
  ...
  "red split lose time back", "world record reaction scream", "popoff keyboard slam desk", "desk slap loud mic", "microphone peak red bar", "headshot sound effect ding", "compilation video editing timeline",
  "clickbait thumbnail red arrow pointing", "shocking face expression hand", "red circle circling nothing grass", "all caps title screaming text", "giveaway scam link hack", "free robux generator fake", "v bucks card code scratch",
  "fortnite battle pass tier", "tier one hundred skin flex", "default dance music lobby", "orange justice dance floor", "take the L dance forehead", "floss dance movement side", "stream sniper stream sniper",
  "delay on stream settings", "chat interaction timer stream", "sub badge loyalty star", "channel points bet red", "prediction winner payout points", "emote chat spam train", "pogchamp face emote hype",
  "kappa sarcastic face text", "resident sleeper yawn emote", "monkas sweat drop frog", "pepe the frog meme sad", "wojak crying mask smug", "chad facial hair beard", "trad wife dress baking",
  "doomer jacket beanie smoker", "bloomer happy face walking", "coomer glasses stare screen", "npc dialog loop greeting", "dialogue skip button mashed", "side quest completion banner", "main quest line done credits",
  "cutscene unskippable watch popcorn", "boss battle phase two music", "health bar refill red screen", "health potion sipping sound", "inventory full weight heavy", "overencumbered walking slow speed", "fast travel blocked enemy",
  "fast travel loading screen painting", "tip text during load screen", "press any key start screen", "title screen music loop drum", "doomscrolling at three AM", "letting him cook too long", "certified classic vine",
  "main character energy mall", "girlboss gaslight gatekeep loop", "side quest distraction hours", "touching grass meme hand", "npc behavior in target", "uncanny mr incredible face", "brain rot definition video",
  "yap session uninterrupted hour", "rizzler training camp", "glazing team sports star", "no cap deadass real", "bruh moment face palm", "doomscrolling bad news thread", "slay queen boots house",
  "giving very much nothing", "hits different in winter", "maintaining an aura points", "brain rot quiz fail", "youtube short looping forever", "tiktok sound stuck head", "dance trend hand movements",
  "lip sync video struggle", "capcut template transition shake", "sped up audio nightcore", "slowed down reverb crying", "minecraft parkour gameplay background", "soap cutting compilation video", "kinetic sand cutting sounds",
  "slime mixing glitter crunch"
];
...
const ADULT_WORDS = [
  ...
  "looking at phone pretend busy wait", "fake phone scroll waiting room", "elevator doors closing button smash", "elevator stop every floor door", "stairs flight heavy breathing door", "stepping off escalator stumble foot", "automatic door slow opening stand",
  "rotating door push effort heavy", "sliding door bump shoulder glass", "push pull door fail public", "pull door says push sign pull", "glass door handprint smudge nose", "clean window nose bump glass", "tripping over flat carpet toe",
  "tripping over own feet sidewalk", "ankle rolling curbside step heel", "dropping pen roll desk chase", "pen cap chew habit mouth", "blue ink leak finger shirt", "pencil lead snap write line", "notebook page torn spiral wire",
  "sticky note lost glue floor", "whiteboard marker dry squeak nose", "eraser dust pants smear gray", "paper shredder paper jam teeth", "printer out of toner red", "printer paper jam tray two pull", "scanning document upside down blank",
  "double sided copy fail flip", "laminated paper bubbles corner scissors", "tape roll end search thumbnail", "scissors cutting wrapping paper slice", "gift wrap tape wrinkle box", "ribbon curl scissor drag sound", "bubble wrap pop impulse finger",
  "cardboard box finger slice sting", "cardboard dust dry skin wash", "paper grocery bag rip bottom", "grocery bag handles breaking street", "dropping eggs kitchen tile yolk", "rolling orange escape floor couch", "shopping cart squeak wheel turn",
  "cart pulls to left track", "long line short lane cash", "item has no barcode clerk", "guess it is free joke laugh", "bag your own groceries paper", "packing groceries heavy bottom bread", "squished bread bottom bag heavy",
  "melted ice cream trunk carton", "warm soda can fizz bubbles", "opening soda can spraying face", "can tab snapping off pull", "jar lid tight grip cloth", "jar lid tapping counter seal", "jar seal pop pop air",
  "bottle opener lost search kitchen", "cork crumbling inside bottle corkscrew", "wine glass stem break wash", "red wine stain carpet foam", "stain remover spray foaming rug", "white shirt coffee drip laundry", "toothpaste spit shirt spot bathroom",
  "toothpaste tube squeezed middle roll", "wet soap bar slip shower", "hair in soap bar shower", "toilet bowl brush chore gloves", "bathroom scale weight sigh heel", "hair thinning forehead mirror look", "grey hair pluck twinge head",
  "eyebrow hair wild stray pluck", "nose hair trimmer tickle sneeze", "paper towel dispenser empty hand", "hand dryer cold air noise", "automatic sink sensor waving hands", "automatic soap dispenser empty wave", "water splash lap pants stain",
  "look like pee stain jeans", "zipper teeth scratch hand pocket", "pocket lining hole coins drop", "dropping coins under seat car", "seat belt click miss click", "toll booth coin drop window", "toll booth ticket lost dashboard",
  "gps voice rerouting recalculating turn", "missed highway exit loop mile", "gravel chip windshield crack lines", "bird poop car window driver", "tree sap sticky hood paint", "car wash soap spots wind", "vacuum cleaner cord reel button",
  "vacuum smells like pet dust", "broom dustpan line sweep jump", "dustpan dust line jump sweep", "feather duster spread dust desk", "ceiling fan dust crust rotation", "blinds cleaning finger wipe dust", "window streak vinegar smell newspaper",
  "clean laundry pile couch mountain", "laundry basket carry hip lean", "laundry drop sock hallway walk", "washing machine off balance bang", "dryer sheet stuck leg pants", "sock static cling shirt armpit", "folded shirt crease lines dress",
  "iron burn mark board cover"
];
