...
export function start(home) {
  ...
  if (__pj && __pj.game === "gartic" && __pj.code && (Date.now() - __pj.ts) < 20000) {
...
// ── Setup screen ──────────────────────────────────────────────────────────────
function renderSetup() {  const savedName = localStorage.getItem("lakehouse.playerName") || localStorage.getItem("gartic.name") || "";
