...
function renderSetup() {
  ...
  try {
    ...
    if (_pj && _pj.game === "chronicles" && _pj.code && (Date.now() - _pj.ts) < 20000) {
  ...
  const savedName = localStorage.getItem("lakehouse.playerName") || localStorage.getItem("chronicles.name") || "";
