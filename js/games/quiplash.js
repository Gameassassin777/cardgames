...
const PROMPTS = [
  ...
  "A terrible name for a new luxury brand of bottled air",
  "The most awkward thing to happen during a solemn moment",
  "A funny name for a bear that is trying to learn how to play the piano",
  "What the ghost of a Victorian gentleman thinks of modern video games",
  "A ridiculous excuse for why your car is full of autumn leaves",
  "Something you shouldn't say to a witch who is brewing a potion",
  "A highly sophisticated squirrel discussing geopolitical borders",
  "The absolute worst song to hum while hiding in a dark closet",
  "A funny name for a tiny ghost that only makes soft squeaking noises",
  "What the antique mirror is secretly thinking when you look into it",
  "A terrible theme for an upscale private art gallery opening",
  "The awkward moment when you try to pet a dog that is actually a statue",
  "What the woodland creatures think of your hiking boots",
  "A funny name for a crab that is trying to start a high-end salon",
  "The worst thing to find inside a beautifully wrapped parcel",
  "A ridiculous fashion trend that requires wearing a fishbowl on your head",
  "What the fireplace sparks are whispering before they go out",
  "A pretentious description of a bowl of instant ramen",
  "Something you shouldn't do while visiting a quiet monastery",
  "A funny name for a wizard whose spells always turn things into cabbage",
  "The real reason why the ancient grandfather clock is ticking backward",
  "What the attic ghosts do when you play classical music downstairs",
  "A terrible excuse for why you brought a metal detector to a picnic",
  "The most awkward thing to say when someone catches you talking to yourself",
  "A highly dramatic badger reciting epic poetry in the rain",
  "What the garden birds think of your singing voice",
  "A funny name for a detective agency run by highly trained ferrets",
  "The absolute worst song to play during a slow-motion dramatic exit",
  "A ridiculous reason to carry a giant brass key everywhere you go",
  "What the lighthouse lantern is thinking when it looks out at the sea",
  "A terrible name for an elegant candle scent",
  "Something you shouldn't say to a giant forest spider",
  "A funny name for a squirrel that thinks it is a medieval knight",
  "The awkward moment you realize you've been wearing your shirt backward all day",
  "What the old dusty books in the library are whispering about",
  "A posh gentleman trying to explain a gaming term to a Victorian ghost",
  "The worst thing to find floating in a fancy champagne glass",
  "A ridiculous excuse for why you have a branch taped to your arm",
  "What the crows are gossiping about during their afternoon meeting",
  "A funny name for a haunted violin that only plays pirate sea shanties",
  "The most pretentious way to describe a glass of tap water",
  "Something you shouldn't do during a high-stakes business negotiation",
  "What the woodland fairies think of your smartphone",
  "A terrible theme for a high-end luxury fashion boutique",
  "A funny name for a penguin that is secretly a brilliant safe-cracker",
  "The absolute worst song to play at a high-end art auction",
  "What the spooky old wardrobe is hiding besides old coats",
  "A ridiculous fashion trend that involves wearing multiple ties as a belt",
  "What the forest deer are thinking when they watch you take a selfie",
  "A funny name for a ghost that is very bad at scaring people",
  "The awkward silence that follows a terrible magic trick",
  "A highly sophisticated owl delivering a lecture on quantum physics",
  "The worst thing to find inside a vintage leather glove",
  "A terrible excuse for why you brought a megaphone to a library",
  "What the grandfather clock is plotting with the hallway mirror",
  "A posh lady trying to describe her experience at a heavy metal concert",
  "Something you shouldn't say to a troll guarding a stone bridge",
  "A funny name for a squirrel that is an expert in interior design",
  "What the campfire smoke is trying to write in the air",
  "The most awkward thing to say when you accidentally join the wrong video conference",
  "A ridiculous reason to build a secret passage in a studio apartment",
  "What the ghost of a pirate captain thinks of modern luxury yachts",
  "A funny name for a tiny dragon that is afraid of heights",
  "The worst thing to find at the bottom of a fancy porcelain teacup",
  "A terrible slogan for an upscale organic boutique",
  "Something you shouldn't do while attending a royal banquet",
  "A ridiculous fashion trend that involves wearing a clock around your neck",
  "What the attic mice think of your taste in music",
  "A funny name for a beaver that is a very demanding contractor",
  "The absolute worst song to play during a tense standoff",
  "What the spooky ancient chest in the basement is whispering",
  "A pretentious food critic describing the elegant structure of a chicken nugget",
  "The awkward moment when you wave back at someone who was waving to the person behind you",
  "What the forest spirits do when you leave a shiny penny on a mossy rock",
  "A funny name for a ghost that is obsessed with organizing your bookshelves",
  "A terrible excuse for why you have a feather boa wrapped around your neck",
  "Something you shouldn't say to a gargoyle that suddenly started talking",
  "A highly sophisticated raccoon criticizing the lack of truffle oil in the trash bin",
  "What the spooky grandfather clock is thinking when the power goes out",
  "A funny name for a wizard who only knows how to summon tiny, angry crabs",
  "The most awkward thing to say to a portrait whose eyes just blinked",
  "A ridiculous reason to wear a monocle to a casual diner",
  "What the trees in the orchard say when they see a basket of apples",
  "A terrible theme for an elite secret society",
  "A funny name for a squirrel that acts like a high-profile paparazzi photographer",
  "The absolute worst song to play while driving a horse-drawn carriage",
  "What the ghost of a Victorian lady thinks of your smart speaker",
  "A ridiculous fashion trend that involves wearing a teapot as a hat",
  "Something you shouldn't do when meeting a mysterious stranger in the woods",
  "A funny name for a pet frog that is convinced it is a prince in disguise",
  "The awkward silence after you make a pun that no one understands",
  "What the library books are thinking when they get placed on the wrong shelf",
  "A pretentious description of a glass of chocolate milk",
  "The worst thing to find inside a drawer of an antique desk",
  "A terrible excuse for why you brought a metal detector to a high-end museum",
  "What the forest creatures think of your brightly colored camping gear",
  "A funny name for an owl that is incredibly clumsy",
  "Something you shouldn't whisper to the person in front of you in a quiet gallery",
  "A ridiculous reason to wear a full tux to a fast-food drive-thru",
  "What the spooky scarecrow is thinking when the wind stops blowing",
  "A funny name for a ghost that only haunts your kitchen garbage disposal",
  "The absolute worst choice of music for a quiet walk in a misty garden",
  "A pretentious sommelier reviewing a bottle of cheap soda",
  "The awkward moment when you try to open a door that says 'pull' by pushing",
  "What the woodland fairies are planning for their midsummer festival",
  "A terrible name for a new luxury brand of designer boots",
  "Something you shouldn't do while visiting an ancient ruins site",
  "A funny name for a squirrel that is an expert in martial arts",
  "What the spooky old hallway mirror says when you walk past it at night",
  "A ridiculous fashion trend that involves wearing two belts on your head",
  "What the garden flowers whisper to the bees",
  "A funny name for a ghost that is very picky about your home decor",
  "The worst thing to find at the bottom of a fancy jewelry box",
  "A terrible excuse for why you are late to a formal ballroom dance",
  "What the trees in the forest are dreaming about during the winter",
  "A highly sophisticated beaver offering architectural advice",
  "Something you shouldn't say to a mysterious fortune teller",
  "A funny name for a wizard who only knows spells to clean teapots",
  "The absolute worst song to play while staring dramatically out a rainy window",
  "A ridiculous excuse for why your pocket is full of cold cooked spaghetti"
];
