...
const STARTING_WORDS = [
  ...
  "Walking clock chasing a sleepy turtle",
  "Tree hugging a human",
  "Banana peeling itself on a stage",
  "Sun wearing a pair of cool sunglasses",
  "Cloud crying a river of hot coffee",
  "Pizza slice eating a human-shaped cookie",
  "Lightbulb having a bright idea",
  "Pencil drawing its own eraser",
  "Book reading a sleepy person to sleep",
  "Key trying to escape a locked door",
  "Shoe wearing a tiny human on its foot",
  "Toothbrush fighting a giant cavity monster",
  "Computer screen looking at a human through a window",
  "Wind blowing a cloud like a balloon",
  "Moon taking a nap on a soft pillow of stars",
  "Raindrop wearing a tiny yellow raincoat",
  "Snowman sitting inside a warm sauna",
  "Flower watering another flower with a watering can",
  "Teapot blowing bubbles instead of steam",
  "Chair sitting on top of a table",
  "Spoon running away with a shiny fork",
  "Broom sweeping up a pile of autumn leaves",
  "Candle melting into a puddle of rainbow wax",
  "Balloon pop creating a cloud of confetti",
  "Mirror reflecting a different room",
  "Clock hands playing a game of tag",
  "Door handle that shakes hands with you",
  "Sock monster eating a matching pairs of socks",
  "Blanket fort that has a secret dungeon",
  "Pillow fight between two giant pillows",
  "Juice box drinking itself through a straw",
  "Ice cube sweating on a sunny summer day",
  "Tornado spinning in a giant teacup",
  "Volcano erupting with sparkling pink glitter",
  "Ocean wave catching a surfer",
  "Lightning bolt lighting up a birthday candle",
  "Star falling out of the sky into a net",
  "Rainbow ending in a pot of golden honey",
  "Feather floating down to tickle a sleeping giant",
  "Giant bubble carrying a house into the sky",
  "Teddy bear having a boxing match with a pillow",
  "Toy robot trying to climb a flight of stairs",
  "Windmill spinning so fast it flies away",
  "Paper airplane carrying a tiny letter",
  "Kite flying a human in the sky",
  "Sandcastle defending itself from a wave",
  "Sea shell whispering a funny secret",
  "Anchor floating on top of the water",
  "Compass pointing in all directions at once",
  "Struggling to open a stubborn banana",
  "Pouring milk before checking if you have cereal",
  "A single sock spinning in the dryer",
  "Washing a spoon and getting sprayed with water",
  "Trying to sleep with a single loud fly in the room",
  "A dog stealing a slice of warm pizza",
  "A cat sitting on a keyboard during a meeting",
  "Putting on a shoe with a tiny pebble inside",
  "Walking into a glass door you thought was open",
  "Trying to whisper but accidentally shouting",
  "Spilling popcorn all over the movie theater floor",
  "An orange peel that comes off in fifty tiny pieces",
  "A toaster burning one side of the bread and leaving the other cold",
  "Dropping a coin under the car seat",
  "Trying to write on a piece of paper on a bumpy bus",
  "A high-fashion runway model slipping on a banana peel",
  "A knight trying to eat spaghetti through a helmet visor",
  "An astronaut trying to scratch an itch on their nose",
  "A caveman trying to assemble Ikea furniture",
  "A wizard using a magic wand as a selfie stick",
  "A vampire getting caught in a bright camera flash",
  "A mummy getting caught in a rotating door",
  "A skeleton trying to drink a glass of water",
  "A ghost trying to scare a very distracted teenager",
  "A witch getting stuck in a tree on her broomstick",
  "A werewolf trying to use a touch screen phone with claws",
  "A zombie trying to do a delicate ballet dance",
  "An alien trying to order food at a drive-thru",
  "A gargoyle trying to hide during a game of hide and seek",
  "A scarecrow trying to make friends with a crow",
  "A sleeping bag monster creeping up a staircase",
  "A midnight ghost making a sandwich in the kitchen",
  "A friendly skeleton wearing a warm winter coat",
  "A haunted teapot pouring green slime",
  "A creepy doll sitting in a tiny rocking chair",
  "A shadow hand shadow-puppeting a human",
  "A ghost pirate sailing in a bathtub",
  "A witch's cauldron bubbling with pink bubblegum",
  "A werewolf brushing its teeth with a giant brush",
  "A mummy wrapped in neon yellow tape",
  "A zombie wearing cool designer sneakers",
  "A alien taking a selfie on the moon",
  "A haunted clock with hands that spin backwards",
  "A ghost dog chasing a ghost mailman",
  "A skeleton wearing a tuxedo at a fancy dinner",
  "A spooky scarecrow doing a funny dance",
  "A swamp monster taking a relaxing bubble bath",
  "A banshee singing a sweet baby lullaby",
  "A vampire eating a strawberry popsicle",
  "A friendly ghost wearing cool sunglasses"
];
