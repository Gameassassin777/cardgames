...
export function start(home) {
  ...
  if (__pj && __pj.game === "farkle" && __pj.code && (Date.now() - __pj.ts) < 20000) {
...
function renderSetup() {  const savedName = localStorage.getItem("lakehouse.playerName") || localStorage.getItem("farkle.name") || "";
